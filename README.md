...
3. Создали в админке пользователей: Логины: category_manager, account_manager  (пароли одинаковые:  GeekBraines@2023)
...
промежуточные формы соответственно в  forms.py, views.py, urls.py, base.html - поменяли пути
